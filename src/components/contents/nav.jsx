...
const Nav = () => {
  ...
  return (
    <nav className={`fixed top-0 z-[888] ${scrolled ? 'bg-[#F5811E]' : 'bg-none'} flex justify-center items-center w-full`}>
      <div className='relative flex justify-center items-center w-full 2xl:w-[1280px] py-[20px] px-[15px] at500:px-[20px] md:px-[80px]'>
        ...
        <div className="relative w-full mx-auto flex md:flex-row justify-between items-start md:items-center">
          ...
          <div className='hidden md:flex justify-end items-center space-x-4 w-full'>
            <a href="#home" className="text-white hover:text-gray-400 font-semibold text-[23px] leading-[24px] capitalize">deals</a>
            <a href="#about" className="text-white hover:text-gray-400 font-semibold text-[23px] leading-[24px] capitalize">contact us</a>
            <a href="#contact" className="text-white hover:text-gray-400 font-semibold text-[23px] leading-[24px] capitalize">subscribe</a>
          </div>
          ...
          <div className="md:hidden absolute top-[73px] transition-all ease-in duration-300 w-full bg-[#F5811E] border-b-white border-b-[3px] border-solid">
            <ul className="flex flex-col justify-start items-start w-full p-[17px] space-y-2">
              <li className='cursor-pointer text-left'>
                <a href="#home" className="text-white hover:text-gray-400 font-semibold text-[23px] leading-[24px] capitalize">deal</a>
              </li>
              <li className='cursor-pointer text-left'>
                <a href="#about" className="text-white hover:text-gray-400 font-semibold text-[23px] leading-[24px] capitalize">contact us</a>
              </li>
